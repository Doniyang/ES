...
export default class Animation extends AbstractAnimate  {
     ...
     * @param notify
     */
    constructor(scope: Scope, roll: RollDigitalizer, notify: Notify) {
        super(scope, roll);
        this.rafId = 0
        this.rafTime = 0;
        this.notify = notify;
    ...
    private isRealtime(): boolean {
        return this.getScope().getProbe() === Probe.Realtime
    }
