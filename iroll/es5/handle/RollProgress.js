...
export default class RollProgress {
    ...
    execute(e, attrs, proxy) {
        ...
        const point = EventKit.isTouchEvent(e) ? e.touches[0] : e, scope = proxy.getScope(), pos = proxy.getPosition(), maxDist = scope.getMaxDistance(), timestamp = DateKit.getTime();
        let deltaX = point.pageX - attrs.getPointX(), deltaY = point.pageY - attrs.getPointY(), newX, newY, absDistX, absDistY;
