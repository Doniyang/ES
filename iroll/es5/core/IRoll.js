...
export default class IRoll {
    ...
    updateScrollOptions(options) {
        ...
        if (!isUndefined(options.wheel) && isNumber(options.wheel.speed)) {
            this.scope.setWheelSpeed(options.wheel.speed);
        }
        if (!isUndefined(options.wheel)) {
            this.scope.setWheelSpeed(options.wheel.invert ? -1 : 1);
        }
        if (!isUndefined(options.wheel)) {
            this.scope.setEnableWheel(options.wheel.enable);
        }
